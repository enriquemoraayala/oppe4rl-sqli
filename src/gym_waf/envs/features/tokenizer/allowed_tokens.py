...
SIMPLE_TOKENS = ['NIL'] + SQL_FUNC
for i in SYMBOL_DEF:
	SIMPLE_TOKENS.append(i[0])
for i in PUNCTATION_SUB:
	SIMPLE_TOKENS.append(i[1])
for i in SYS_DEF:
	SIMPLE_TOKENS.append(i[0])
for i in USR_DEF:
	SIMPLE_TOKENS.append(i[0])
for i in NUMB_TOKENS:
	SIMPLE_TOKENS.append(i)
SIMPLE_TOKENS.append("STR")
SIMPLE_TOKENS.append("CHR")
SIMPLE_TOKENS.append("SPC")
...
def substitute_sysinfo(query, insert_space=False):
	query = _substitute_list_token(SYMBOL_DEF, query, insert_space=True)
